...
The next revenue-related action is not selling. It is getting one outside reviewer outcome through [reviewer-quick-verdict.md](reviewer-quick-verdict.md), [external-repo-trial.md](external-repo-trial.md), or [round1-reviewer-request.md](round1-reviewer-request.md).
