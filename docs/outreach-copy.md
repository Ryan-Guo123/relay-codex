...
If you review AI-generated PRs, could you try the 10-minute reviewer path?

1. Generate `.relay/reviewer-pack.md`
2. Compare it with a normal Codex/manual summary
...
Would you be open to spending 10 minutes comparing one generated handoff against a normal Codex/manual PR summary?
